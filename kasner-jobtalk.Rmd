...
```{r talk-map-2a, echo=FALSE, out.width = '150%', fig.align="center"}
knitr::include_graphics("images/talk-map-full-0.png")
```

.footnote[
<tiny><small>Source: Government of Canada, 2022. National Academies of Science, 1997. </small></tiny>
>>>>>>> gh-pages
]
...
```{r talk-map-2b, echo=FALSE, out.width = '150%', fig.align="center"}
knitr::include_graphics("images/talk-map-full.png")
```
